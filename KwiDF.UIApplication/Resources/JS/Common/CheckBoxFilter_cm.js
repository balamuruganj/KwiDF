...
$(document).ready(function () {
    ...
    $(".wrapper").append("<ul style='list-style: none;margin:0;padding:0'><li style='padding-bottom:5px;'><input class='Checkbox' id='checkbox0' type='checkbox' value='Sum([ReservoirPotential]) as [Reservoir Potential]' /> <span style='color: #ffffff;'>Reservoir Potential</span>&nbsp;</li><li style='padding-bottom:5px;'><input class='Checkbox' type='checkbox' id='checkbox1' value='Sum([WellPotential]) as [Well Potential]' /> <span style='color: #ffffff;'>Well Potential</span>&nbsp;</li><li style='padding-bottom:5px;'><input class='Checkbox' type='checkbox' id='checkbox2' value='Sum([PipelinePotential]) as [Pipeline Potential]' /> <span style='color: #ffffff;'>Pipeline Potential </span>&nbsp;</li><li style='padding-bottom:5px;'><input class='Checkbox' type='checkbox' value='Sum([IntegrityCapacity]) as [Integrity Capacity]'  id='checkbox3'/><span style='color: #ffffff;'>Integrated Potential</span>&nbsp;</li><li><input class='Checkbox' type='checkbox' value='Sum([DCPFull]) as [DCP]' id='checkbox4' /> <span style='color: #ffffff;'>DCP</span></li></ul>");    
